      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-bold font-poppins mb-4">Github <span className="text-accent">Contributions</span></h3>
          ...
          >
            <div className="bg-gradient-to-br from-secondary/5 to-accent/5 backdrop-blur-sm border border-secondary/10 rounded-2xl p-6 md:p-8 hover:shadow-2xl hover:shadow-accent/20 hover:border-accent/30 transition-all duration-500">
              <div className="text-center mb-8">
                <div className="w-16 h-16 bg-gradient-to-br from-accent/10 to-accent/5 rounded-2xl flex items-center justify-center border border-accent/20 mx-auto mb-4">
                ...
                <h4 className="text-xl md:text-2xl font-bold text-secondary mb-3">VulcanoCraft Plugin Repository</h4>
                <div className="flex items-center justify-center gap-3 mb-4">
                  <span className="px-3 py-1 bg-accent/10 text-accent text-sm rounded-full border border-accent/20">4 Pull Requests</span>
                  <span className="px-3 py-1 bg-green-500/10 text-green-400 text-sm rounded-full border border-green-500/20">All Merged</span>
                </div>
                <p className="text-secondary/70 mb-6 max-w-2xl mx-auto">Contributing admin features, performance optimizations, and platform integrations to VulcanoSoftware's plugin repository.</p>
                <a
                  href="https://github.com/VulcanoSoftware/VulcanoCraft-plugin-repository"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-accent/10 text-accent border border-accent/30 rounded-lg hover:bg-accent hover:text-primary transition-all duration-300 font-medium"
                >
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-secondary/5 to-accent/5 rounded-xl p-5 border border-secondary/10 hover:border-accent/30 transition-all duration-300">
                  <a href="https://github.com/VulcanoSoftware/VulcanoCraft-plugin-repository/pull/5" target="_blank" rel="noopener noreferrer" className="block group">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <span className="text-lg font-bold text-accent group-hover:text-accent-coral transition-colors">#5</span>
                        <span className="px-2 py-1 bg-green-500/10 text-green-400 text-xs rounded-full border border-green-500/20">Merged</span>
                      </div>
                      <svg className="w-5 h-5 text-secondary/40 group-hover:text-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                      </svg>
                    </div>
                    <h5 className="text-base font-semibold text-secondary/90 mb-2">Role-based Admin Panel</h5>
                    <p className="text-sm text-secondary/70">Implemented comprehensive 3-tier permission system with role management</p>
                  </a>
                </div>
                
                <div className="bg-gradient-to-r from-secondary/5 to-accent/5 rounded-xl p-5 border border-secondary/10 hover:border-accent/30 transition-all duration-300">
                  <a href="https://github.com/VulcanoSoftware/VulcanoCraft-plugin-repository/pull/7" target="_blank" rel="noopener noreferrer" className="block group">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <span className="text-lg font-bold text-accent group-hover:text-accent-coral transition-colors">#7</span>
                        <span className="px-2 py-1 bg-green-500/10 text-green-400 text-xs rounded-full border border-green-500/20">Merged</span>
                      </div>
                      <svg className="w-5 h-5 text-secondary/40 group-hover:text-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    ...
                    <h5 className="text-base font-semibold text-secondary/90 mb-2">Performance Optimization</h5>
                    <p className="text-sm text-secondary/70">Achieved 3x faster scraping with intelligent caching system</p>
                  </a>
                </div>
                
                <div className="bg-gradient-to-r from-secondary/5 to-accent/5 rounded-xl p-5 border border-secondary/10 hover:border-accent/30 transition-all duration-300">
                  <a href="https://github.com/VulcanoSoftware/VulcanoCraft-plugin-repository/pull/8" target="_blank" rel="noopener noreferrer" className="block group">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <span className="text-lg font-bold text-accent group-hover:text-accent-coral transition-colors">#8</span>
                        <span className="px-2 py-1 bg-green-500/10 text-green-400 text-xs rounded-full border border-green-500/20">Merged</span>
                      </div>
                      <svg className="w-5 h-5 text-secondary/40 group-hover:text-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    ...
                    <h5 className="text-base font-semibold text-secondary/90 mb-2">CurseForge & API Migration</h5>
                    <p className="text-sm text-secondary/70">Migrated to modern APIs delivering 60%+ performance boost</p>
                  </a>
                </div>
                
                <div className="bg-gradient-to-r from-secondary/5 to-accent/5 rounded-xl p-5 border border-secondary/10 hover:border-accent/30 transition-all duration-300">
                  <a href="https://github.com/VulcanoSoftware/VulcanoCraft-plugin-repository/pull/9" target="_blank" rel="noopener noreferrer" className="block group">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <span className="text-lg font-bold text-accent group-hover:text-accent-coral transition-colors">#9</span>
                        <span className="px-2 py-1 bg-green-500/10 text-green-400 text-xs rounded-full border border-green-500/20">Merged</span>
                      </div>
                      <svg className="w-5 h-5 text-secondary/40 group-hover:text-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    ...
                    <h5 className="text-base font-semibold text-secondary/90 mb-2">Version Fetching Fixes</h5>
                    <p className="text-sm text-secondary/70">Fixed version detection for accurate Minecraft compatibility</p>
                  </a>
                </div>
              </div>
            </div>
